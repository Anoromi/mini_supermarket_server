...
const _lazy_n52DcW = () => import('./index.post.mjs');
const _lazy_LpU4Kn = () => import('./index.post2.mjs');

const handlers = [
  { route: '/signup', handler: _lazy_n52DcW, lazy: true, middleware: false, method: "post" },
  { route: '/signin', handler: _lazy_LpU4Kn, lazy: true, middleware: false, method: "post" }
];
